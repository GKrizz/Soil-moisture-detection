...
String Sheets_GAS_ID = "AKfycbw0ZQ4p76Y123on1hcIU3vbEIZd08OrCk6RH7U8GkTR4AnqTyrmmvwpV3Dg1qBMm8Ijkw";                                         
...
void setup() 
{
  Serial.begin(9600);
  while (!Serial);
  WIFI_Connect("GOJO","12345678900");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
